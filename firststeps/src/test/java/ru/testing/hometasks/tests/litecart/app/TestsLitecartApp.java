...
public class TestsLitecartApp extends TestBase {
  ...
  @Test
  public void testTask11NewCustomerReg() {
    driver.navigate().to("http://localhost/litecart/public_html/en/");
    ...
    email.clear();
    email.sendKeys("VasisualiyLohankin@sermjagnaya.pr");
    ...
    WebElement coonfirmPsw = driver.findElement(By.xpath(".//*[@id='create-account']//table//tr[8]//td[2]/input"));
    coonfirmPsw.clear();
    coonfirmPsw.sendKeys("passwordQwe123");
